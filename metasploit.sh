...
echo "##############################################"
echo " SUBSCRIBE MY CHANNEL Spy4data "
echo "##############################################"
...
echo "###############################################" echo "Subscribe 
My Channel To Motivate My Work" echo 
"###############################################" echo 
"###############################" echo "For More. Visit At Tech-Spy4data 
" echo "Visit my blog https:www.spy4data.wordpress.com" echo 
"####################################" echo " NOW YOU CAN LAUNCH 
METASPLOIT BY JUST EXECUTE THE COMMAND :=> ./msfconsole" echo 
"####################################" exec bash
